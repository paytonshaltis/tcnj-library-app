...
// *********** room 220 ***************************************************
    ...
    index++;
    index++;
    if (this.secondFloorRooms[index].status == 0 || this.secondFloorRooms[index - 1].status == 0) {
      oneSensor = 0;
    } else {
      oneSensor = 1;
    }
    ctx.strokeStyle = this.colors[oneSensor];
    //ctx.lineWidth=6;
...
// *********** room 413 ***************************************************
    ...
    index++;
    index++;
    if (this.fourthFloorRooms[index].status == 0 || this.fourthFloorRooms[index - 1].status == 0) {
      oneSensor = 0;
    } else {
      oneSensor = 1;
    }
